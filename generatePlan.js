            ...
            messages: [
              {
                "role": "system",
                "content": `
                если пользователь говорит "сегодня", то это значит что он имеет ввиду ${dayOfWeekRu}. Если пользователь просит показать расписание на все дни, верни массив со всеми 7 днями недели. Если пользователь не говорит на какой день создает расписание, тогда учитывай что он имел ввиду ${dayOfWeekRu}.
